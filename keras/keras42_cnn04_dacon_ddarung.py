...
print(x.shape, y.shape) #💟💟💟
print(x_train.shape, y_train.shape) #(929, 9) (929,)
print(x_test.shape, y_test.shape) #(399, 9) (399,)
...
#2. 모델구성
model = Sequential()
model.add(Conv2D(64,(3,1),activation='relu',input_shape=(9,1,1)))  #💟💟💟💟💟
...
filepath ="".join([path,"k31_dacon ddrung_",date,"-", filename])
